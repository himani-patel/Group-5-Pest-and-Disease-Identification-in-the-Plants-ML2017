function [mat,seg1] = LearnROI
  folderName='/media/divya/EDUCATION/SEAS_6th_Sem/ML/Project_sir/ROI_Diseased/';
  extension='*.jpg';
...
%         seg1(l,6)=applyMat(round(cellSize/2),round(cellSize/2),3);
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 folderName='/media/divya/EDUCATION/SEAS_6th_Sem/ML/Project_sir/ROI_Leaf/';
  extension='*.jpg';
  concattedString=strcat(folderName, extension);
  fileSet=dir(concattedString);
  cellSize=35;
